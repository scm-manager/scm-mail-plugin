...
title: Testing
---
You can test this plugin against email testing tools like “[MailHog](https://github.com/mailhog/MailHog)”.
...
Alternatively, simply use `docker-compose`:
```
docker-compose up
```
...
In order to track the certificate tests, the scm-ssl-context-plugin ought to be installed.
